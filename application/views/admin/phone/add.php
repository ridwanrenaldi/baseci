        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card card-info">
              ...
              <!-- form start -->
              <?= form_open_multipart('admin/phone/add', array('class' => 'form-horizontal')) ?>
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="text" name="_number_" class="form-control" id="_number_" placeholder="Number" value="<?php echo set_value('_number_'); ?>" required="required" maxlength="250">
                    </div>
                  </div>
