        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card card-info">
              ...
              <!-- form start -->
              <?= form_open_multipart('admin/profile/edit', array('class' => 'form-horizontal')) ?>
                <div class="card-body">
...
<script>
  ...
  $(document).ready(function(){
    $('#_checkusername_ , #_checkemail_ , #_checkpassword_').on('change', function(){
      var id = $(this).attr('id');
